...
<div class="table-section">
    ...
    <form id="registForm" method="post">
        <table class="search-table regist-table">
            ...
            <tr>
                <th>비밀번호</th>
                <td colspan="3"><input type="password" id="password" name="password" class="form-control me-2 widthAuto" maxlength="20" placeholder="영문/숫자/특수문자5~15자리" required /></td>
            </tr>
            <tr>
                <th>비밀번호확인</th>
                <td colspan="3"><input type="password" id="confirmPassword" name="confirmPassword" class="form-control me-2 widthAuto" maxlength="20" placeholder="영문/숫자/특수문자5~15자리" required /></td>
            </tr>
            <tr>
                <th>이름</th>
