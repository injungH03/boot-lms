...
<div class="table-section">
    ...
    <form id="registForm" method="post">
        <table class="search-table regist-table">
            <tr>
                <th>아이디</th>
                <td colspan="3"><input type="text" name="id" value="${member.id }" class="form-control me-2 widthAuto"  readonly maxlength="20" /></td>
            </tr>
            <tr>
                <th>비밀번호</th>
            ...
            <tr>
                <th>직업</th>
                <td colspan="3"><input type="text" name="job" value="${member.job }" class="form-control me-2 widthAuto"  maxlength="10" /></td>
            </tr>
            <tr>
                <th>주소</th>
                <td colspan="3">
            ...
            <tr>
                <th>강사 소개(최대 300자)</th>
                <td colspan="3">
                    <textarea id="bios" name="bios" class="area" maxlength="300" ><c:out value="${member.bios}" /></textarea><br/>
            ...
            <tr>
                <th>경력 사항(최대 500자)</th>
                <td colspan="3">
                    <textarea id="career" name="career" class="area"  maxlength="500" ><c:out value="${member.bios}" /></textarea><br/>
